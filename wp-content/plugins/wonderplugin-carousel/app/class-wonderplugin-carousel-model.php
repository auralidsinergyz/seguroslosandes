...
class WonderPlugin_Carousel_Model {
	...
	function generate_body_code($id, $has_wrapper) {
		...
		if ($item_row != null)
		{
			...
			$boolOptions = array('autoplay', 'random', 'autoplayvideo', 'circular', 'responsive', 'showhoveroverlay', 'showhoveroverlayalways', 'lightboxresponsive', 'lightboxshownavigation', 'lightboxshowtitle', 'lightboxshowdescription', 'usescreenquery');
